...
namespace Dijsktra
{
    public partial class Form1 : Form
    {
        ...
        private void novoOzadje(object sender, EventArgs e)
        {
            ...
            //using (Graphics g = platno.CreateGraphics())
            //{
            //    g.Clear(Color.White);
            //}
        }
        private void klikMiske(object sender, MouseEventArgs e)
        {
            ...
            DrawCircle(e, arg, x, y, 10, 10);
            platno.Invalidate();
        }

        private void DrawCircle(MouseEventArgs a, PaintEventArgs e, int x, int y, int width, int height)
        {
   ...
   Color.FromArgb(255, 255, 0, 0));
            ...
            //e.Graphics.DrawString("Hello", platno.Image.Fo,a.Location)
        }
        ...
        /// 
        //Dodaj spreminjanje tabele v to funkcijo
